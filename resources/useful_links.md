...
- [Altissan Tutorial](https://www.atlassian.com/git/tutorials/comparing-workflows/gitflow-workflow)
- [Gitflow: Release & Hotfix](https://medium.com/hard-work/gitflow-release-hotfix-bddee96fc5c3)
...
- [Git cheatsheet - Really good](https://www.digitalocean.com/community/cheatsheets/how-to-use-git-a-reference-guide)
...
- [Work with Your History in Git](gitflow_toy/resources/useful_links.md)
- [How To Rename a Local and Remote Git Branch](https://linuxize.com/post/how-to-rename-local-and-remote-git-branch/)
- [Changeing a commit message](https://docs.github.com/en/github/committing-changes-to-your-project/changing-a-commit-message)
- [How to undo a git pull?](https://stackoverflow.com/questions/5815448/how-to-undo-a-git-pull)
- [Installing Git on your operating system](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git).
...
- [The Unix Workbench: Git and GitHub](https://github.com/seankross/the-unix-workbench/blob/master/docs/06-Git-and-GitHub.md)
- [How To Create a Pull Request on GitHub](https://www.digitalocean.com/community/tutorials/how-to-create-a-pull-request-on-github#sync-the-fork)
...
- [GitHub Actions](https://docs.github.com/en/actions/getting-started-with-github-actions/about-github-actions#:~:text=Further%20reading-,About%20GitHub%20Actions,to%20create%20a%20custom%20workflow.)
